			...
			public void actionPerformed(ActionEvent args0) 
			{
				try{
					...
					if(password.equals(password1))
					{
						...
						String getcount="select count(*) from Customer";
						ResultSet r=st.executeQuery(getcount);
						r.next();
						int cid=r.getInt("count(*)");
						cid++;
			        		String sql ="insert into Customer values('"+cid+"', '"+name+"', '"+email+"', '"+usname+"', '"+password+"')";
